...
public class Server {
    public static void main(String[] args) {
        try {
            ...
            String uppercaseMessage = message.toUpperCase(); // Convert the message to uppercase
            writer.println(uppercaseMessage); // Send the uppercase message back to the client
